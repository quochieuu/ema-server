        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentAge = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ChildName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChildBirth = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ChildGender = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InCorrectAnswer4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InCorrectAnswer5 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PostBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blog_AppUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceipId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FriendShip_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Post_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LesionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessionQuiz", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessionQuiz_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessionQuiz_Lession_LessionId",
                        column: x => x.LessionId,
                        principalTable: "Lession",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessionQuiz_Quiz_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quiz",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RightOrWrong = table.Column<bool>(type: "bit", nullable: false),
                    NoExams = table.Column<int>(type: "int", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserQuiz_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FriendList_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FriendList_FriendShip_FriendShipId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostComments_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostLike_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "92ae4f00-413c-417c-8a85-de57152d540d", "Administrator role", "Admin", "ADMIN" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "Đà Nẵng", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), false, null, "70a87035-f871-4667-a004-5c7c65db6e3e", "ema@gmail.com", true, null, false, null, "EMA@GMAIL.COM", "EMA@GMAIL.COM", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Administrator", "AQAAAAEAACcQAAAAEJTXtwLxIyS3SEiQoubxJrZhGhboYjWBQXAMA5yE8c1roAQ4WRZyRMYG72DdFZ/+Dw==", "0123456789", false, "", false, "/upload/avatar/admin1.jpg", "0123456789" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendList_AppUserId",
                table: "FriendList",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_FriendList_FriendShipId",
                table: "FriendList",
                column: "FriendShipId");

            migrationBuilder.CreateIndex(
                name: "IX_FriendShip_AppUserId",
                table: "FriendShip",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LessionQuiz_AppUserId",
                table: "LessionQuiz",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LessionQuiz_LessionId",
                table: "LessionQuiz",
                column: "LessionId");

            migrationBuilder.CreateIndex(
                name: "IX_LessionQuiz_QuizId",
                table: "LessionQuiz",
                column: "QuizId");
